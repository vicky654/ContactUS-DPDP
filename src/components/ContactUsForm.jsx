...
export default function ContactForm() {
  ...
  const validationSchema = Yup.object({
    ...
    otp: showOtp ? Yup.string().length(6, "OTP must be 6 digits") : Yup.string(),
  });
      ...
      <div className="mt-6">
        ...
        <div className="w-2/3 p-8">
          <h2 className="text-lg font-bold mb-6">
            Contact Us for DPDPA Compliance Services | Data Privacy Experts | DPD Consultants
          </h2>
          ...
          <form onSubmit={formik.handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              >
                ...
                <option value="training_education">Training & Education Programs</option>
                ...
                <option value="gap_assessment">Gap Assessment & Remediation</option>
